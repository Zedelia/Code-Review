...
?>
<div class="columns">
<form class="column is-half is-offset-one-quarter" action="/index.php/Register/sendmail" method="post">
    ...
    <div class="field">
        <button class="button is-medium is-fullwidth is-primary" type="submit">Renvoyez moi un mail</button>
    </div>
</form>
</div>